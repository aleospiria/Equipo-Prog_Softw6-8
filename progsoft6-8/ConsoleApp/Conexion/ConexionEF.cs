...
namespace ConsoleApp.Conexion
{
    ...
    {
        private string string_conexion = "server=DESKTOP-VAKQHL3\\DEV;database=db_facturas;uid=sa;pwd=HHG67hgjhg67t!;TrustServerCertificate=true";
