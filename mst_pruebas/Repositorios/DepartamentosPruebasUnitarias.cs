...
namespace mst_pruebas.Repositorios
{
    ...
    public class DepartamentosPruebasUnitarias
    {
        ...
        private void Guardar()
        {
            ...
            {
               NombreDepartamento = "Nombreprueba"
            };
        ...
        {
            entidad!.NombreDepartamento = "Nombre prueba modificado";
