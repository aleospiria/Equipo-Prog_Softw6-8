...
namespace asp_Presentaciones.Pages.Ventanas
{
    ...
    {
        private ICursosPresentacion? iPresentacion = null;

        public CursosModel(ICursosPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public Cursos? Actual { get; set; }
        [BindProperty] public Cursos? Filtro { get; set; }
        [BindProperty] public List<Cursos>? Lista { get; set; }
