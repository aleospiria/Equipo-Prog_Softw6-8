...
namespace lib_aplicaciones.Implementaciones
{
    public class DepartamentosAplicacion : IDepartamentosAplicacion
    {
        ...
        public List<Departamentos> Buscar(Departamentos entidad, string tipo)
        {
            ...
            switch (tipo.ToUpper())
            {
                case "NOMBRE": condiciones = x => x.NombreDepartamento!.Contains(entidad.NombreDepartamento!); break;
                case "COMPLEJA":
                    condiciones =
                        x => x.NombreDepartamento!.Contains(entidad.NombreDepartamento!); break;
